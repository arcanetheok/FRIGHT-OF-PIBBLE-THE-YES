...
if (state != (141 << 0))
{
    with (other)
    {
        if (y < other.y && attacking == 0 && sprite_index != spr_player_mach2jump && ((state == (3 << 0) && vsp > 0) || state == (92 << 0) || state == (103 << 0) || state == (79 << 0)) && vsp > 0 && other.vsp >= 0 && sprite_index != spr_stompprep)
        {
