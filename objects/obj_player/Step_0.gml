...
if ((state == (0 << 0) || state == (187 << 0) || state == (92 << 0) || state == (103 << 0) || state == (104 << 0) || state == (121 << 0)) && key_shoot2 && global.noisejetpack == 1)
{
    vsp = -14
    state = (254 << 0)
...
if (state != (112 << 0) && place_meeting(x, y, obj_boxofpizza))
    state = (100 << 0)
if (shoot_buffer > 0)
    shoot_buffer--
