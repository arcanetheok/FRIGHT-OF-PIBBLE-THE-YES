...
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1766)
    layer_background_sprite(back_id, 1765)
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1763)
    layer_background_sprite(back_id, 1764)
if (global.panic == 1 && layer_background_get_sprite(back_id3) == 1770)
    layer_background_sprite(back_id3, 1771)
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1715)
    layer_background_sprite(back_id, 1717)
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1719)
    layer_background_sprite(back_id, 1722)
if (global.panic == 1 && layer_background_get_sprite(back_id2) == 1723)
    layer_background_sprite(back_id2, 1724)
if (global.panic == 1 && layer_background_get_sprite(back_id) == 1824)
    layer_background_sprite(back_id, 1825)
if (global.panic == 1 && layer_background_get_sprite(back_id2) == 1822)
    layer_background_sprite(back_id2, 1823)
if (global.panic == 1 && layer_background_get_sprite(back_id3) == 1818)
