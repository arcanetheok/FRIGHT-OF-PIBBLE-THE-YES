...
else if (global.levelcomplete && (!global.chateaucutscene))
{
    ...
    currentroom = room
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 324], [cutscene_player_idleanim], [cutscene_change_room, 171], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1888, 369], [cutscene_wait, 100], [cutscene_change_room, currentroom], [cutscene_set_player_visible, 1], [function() //anon_gml_RoomCC_hub_medievallobby_7_Create_1660_gml_RoomCC_hub_medievallobby_7_Create
    {
        with (obj_player)
        {
            state = (0 << 0)
