if (global.levelcomplete && (!global.freezercutscene))
{
    ...
    currentroom = room
    dragonactor = 118675
    scene_info = [[cutscene_medieval_start], [cutscene_waitfor_sprite, 324], [function() //anon_gml_RoomCC_hub_freezerlobby_3_Create_344_gml_RoomCC_hub_freezerlobby_3_Create
    {
        with (obj_actor)
        {
...
], [cutscene_change_room, 228], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1407, 415], [cutscene_wait, 20], [function() //anon_gml_RoomCC_hub_freezerlobby_3_Create_1305_gml_RoomCC_hub_freezerlobby_3_Create
    {
...
], [cutscene_soundeffect, 27], [cutscene_camera_shake, 5, (3 / room_speed)], [function() //anon_gml_RoomCC_hub_freezerlobby_3_Create_2177_gml_RoomCC_hub_freezerlobby_3_Create
    {
        with (dragonactor)
        {
...
], [cutscene_wait, 50], [cutscene_change_room, 214], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 190, 600], [cutscene_soundeffect, 27], [cutscene_camera_shake, 5, (3 / room_speed)], [cutscene_wait, 50], [function() //anon_gml_RoomCC_hub_freezerlobby_3_Create_2834_gml_RoomCC_hub_freezerlobby_3_Create
    {
        with (obj_freezerblock)
            instance_destroy()
        cutscene_end_action()
